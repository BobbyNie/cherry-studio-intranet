 ...
 * Generated at: 2026-09-06T05:53:44.989Z
 *
...
export const bootConfigSchema = z.object({
   ...
   */
  // preboot/network-policy/intranetNetworkAllowlist
  'app.network.intranet_allowlist': z.string(),
   ...
   */
  // preboot/network-policy/intranetNetworkAllowlistInitialized
  'app.network.intranet_allowlist_initialized': z.boolean(),
...
export const DefaultBootConfig: BootConfigSchema = {
  ...
  'app.network.intranet_allowlist_initialized': false,
  'app.user_data_path': {},
