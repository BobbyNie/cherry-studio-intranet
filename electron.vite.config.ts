...
const intranetEnv = {
  'import.meta.env.CHERRY_OFFLINE_MODE': JSON.stringify(process.env.CHERRY_OFFLINE_MODE ?? ''),
  ...
  'import.meta.env.CHERRY_LOCAL_MODEL_ALLOWED_PORTS': JSON.stringify(process.env.CHERRY_LOCAL_MODEL_ALLOWED_PORTS ?? '')
}
